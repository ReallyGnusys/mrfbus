...
/* depends on code copyright Texas Instruments */
...
unsigned char RF1A_IFCTL1, RFIA_CNT;

unsigned char rfDummyVar[2];
void rfDummy(){

  rfDummyVar[0] = RF1AIFCTL1;
  rfDummyVar[1] = RF1A_IFCTL1;
